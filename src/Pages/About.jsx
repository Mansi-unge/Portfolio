  ...
  return (
    <section className="bg-[#0d1117] text-[#c9d1d9] px-6 py-14 md:px-20 lg:px-32">
      ...
      <p className="text-center text-gray-400 text-base md:text-lg font-mono max-w-3xl mx-auto leading-relaxed animate-fade-in mb-6">
        I’m <Highlight>Mansi Unge</Highlight>, a passionate{" "}
        <Highlight>UI/UX Designer</Highlight>, <Highlight>Frontend Developer</Highlight>,
        and <Highlight>Full Stack Developer</Highlight> who loves building impactful
        developer tools and web products. I’m currently deep-diving into{" "}
        <Highlight>DevOps</Highlight> and scaling my flagship platform —{" "}
        <Highlight>CrackIt.dev</Highlight>.
      </p>
      ...
      <div className="mt-12 mb-10 space-y-4 max-w-7xl text-center mx-auto animate-fade-in-up text-sm md:text-base text-gray-400 font-mono">
        <p>
          I've built solutions across industries — from{" "}
          <Highlight>e-commerce</Highlight> and{" "}
          <Highlight>real-time drone tracking</Highlight> to{" "}
          <Highlight>interview prep platforms</Highlight>.
        </p>
        <p>
          Now focusing on building{" "}
          <Highlight>scalable, production-ready apps</Highlight> with modern
          DevOps practices and clean architectures.
        </p>
        <p>
          When I need a break from code, you’ll find me dancing — a creative
          outlet that fuels my problem-solving spirit.
        </p>
      </div>
      ...
      <div className="max-w-4xl mx-auto mb-10 animate-fade-in-up">
        ...
        <ul className="space-y-3 text-sm text-gray-400 font-mono">
          <li className="flex items-start gap-2">
            ...
            <span>
              <Highlight>Maharashtrian Jewelry Store</Highlight> – Built full
              e-commerce site with user auth and cart functionality.
            </span>
          </li>
          <li className="flex items-start gap-2">
            <MdAirplanemodeActive className="text-teal-400 mt-1" />
            <span>
              <Highlight>Shakti Drone Tracker</Highlight> – Visualized
              real-time drone telemetry with React and API integration during
              internship at PRYM.
            </span>
          </li>
          <li className="flex items-start gap-2">
            ...
            <span>
              <Highlight>CrackItDev</Highlight> – Full-stack interview prep
              platform with coding challenges, MCQs, filterable sections,
              points, and badge systems using MERN stack.
            </span>
          </li>
          <li className="flex items-start gap-2">
            <FaBuilding className="text-yellow-400 mt-1" />
            <span>
              <Highlight>Ashiyana Real Estate App</Highlight> – Designed a real
              estate listing platform with property filtering, map view, and
              user authentication using React and Node.js.
            </span>
          </li>
        </ul>
      </div>
      ...
      <div className="max-w-4xl mx-auto mb-20 animate-fade-in-up">
        ...
        <ul className="list-disc list-inside text-sm text-gray-400 space-y-2 font-mono">
          ...
          <li>
            Scaling CrackIt.dev for real-world interview prep & DevTools
          </li>
        </ul>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16 text-sm font-mono">
        ...
        <SkillGroup
          title=" Backend & APIs"
          skills={["Node.js", "Express.js", "Flask", "REST APIs", "JWT", "OAuth"]}
          icons={{
        ...
        <SkillGroup
          ...
          icons={{
            ...
            "Core Java": <FaJava className="text-red-400" />,
          }}
        />
        ...
        <SkillGroup
          title="Dev Tools"
          skills={["VS Code", "Postman", "Thunder Client"]}
        />
      </div>

      {/* Contact & Fun */}
      <div className="text-center animate-fade-in-up">
        <p className="text-sm md:text-base font-mono text-gray-400 mb-2">
          Reach out:{" "}
          <a
        ...
        <p className="text-sm md:text-base font-mono text-gray-400 mb-6">
          🔗 LinkedIn:{" "}
          <a
            href="https://linkedin.com/in/mansi-unge-8825ba312"
            target="_blank"
            className="text-[#58a6ff] hover:underline"
          >
            linkedin.com/in/mansi-unge
          </a>
        </p>
        <p className="text-md md:text-base font-mono text-gray-400 mt-2">
          Fun fact: When I’m not coding, I’m dancing my way to creative
          breakthroughs!
        </p>
      </div>
    </section>
